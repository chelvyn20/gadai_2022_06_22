...
public class CustomersSpec implements Specification<CustomerEntity>{
    private CustomerModel customerModel;

    public CustomersSpec(CustomerModel customerModel){
        super();
    ...
    public Predicate toPredicate(Root<CustomerEntity> root, CriteriaQuery<?>cq, CriteriaBuilder cb){
        ...
        // if(customerModel.getCustStatus()!=null && customerModel.getCustStatus().trim()
        ...
        //     p.getExpressions().add(cb.equal(cb.upper(root.get("custStatus")),
        //     customerModel.getCustStatus().toUpperCase()));
        // }
