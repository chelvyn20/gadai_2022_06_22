...
CREATE TABLE ms_product(
    ...
    product_biaya_admin_buka NUMERIC(12,2) NOT NULL,
    product_biaya_admin_buka_tipe VARCHAR(10) NOT NULL,
    product_biaya_admin_tutup NUMERIC(12,2) NOT NULL,
    product_biaya_admin_tutup_tipe VARCHAR(10) NOT NULL,
